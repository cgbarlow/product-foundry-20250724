...
Standard protocols can be executed on request, e.g. "Initialize CI protocol" or inferred: 
...
##### 🎯 PHASE 1: Planning
*Important note on labels: check what labels are available before creating github issues, and create any labels required before attempting to create the issue*
